...
public class Pick_Up extends Vehiculo implements Serializable{
    ...
    public Pick_Up(String marca, String modelo, String cambios, double velMaxima, String cilindraje,
			...
			boolean vel_Crucero, boolean abs, boolean esCuatroPorCuatro) {
	...
	public Pick_Up(int num_pasajeros, int num_Puertas, int num_Bolsas, int capacidadCarga, boolean aire_Acondicionado,
