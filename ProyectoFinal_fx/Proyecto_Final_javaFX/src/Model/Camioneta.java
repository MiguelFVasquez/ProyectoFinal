...
public class Camioneta extends Sedan  implements Serializable{
    ...
    //Constructor con la variable local
     ...
     */
    //Constructor con todos los atributos, de los que extiende y el propio
	public Camioneta(String marca, String modelo, String cambios, double velMaxima, String cilindraje,
		...
		super(marca, modelo, cambios, velMaxima, cilindraje, transmicion, combustible, estado, num_pasajeros,
				num_Puertas, cap_Maletero, aire_Acondicionado, cam_Reversa, num_Bolsas, abs, sen_Colision,
